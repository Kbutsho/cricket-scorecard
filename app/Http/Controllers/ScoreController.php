...
class ScoreController extends Controller
{
    public function showAdminScore($matchId)
    {
        ...
        $secondBowlingTeam = Innings::where('match_id', $matchId)
            ...
            ->select('bowlingTeam_id')
            ->first();
        $firstBattingSquad = Squad::where('team_id', $firstBattingTeam->battingTeam_id)->where('match_id' , $matchId)->get();
        $firstBowlingSquad = Squad::where('team_id', $firstBowlingTeam->bowlingTeam_id)->where('match_id' , $matchId)->get();
        $secondBattingSquad = Squad::where('team_id', $secondBattingTeam->battingTeam_id)->where('match_id' , $matchId)->get();
        $secondBowlingSquad = Squad::where('team_id', $secondBowlingTeam->bowlingTeam_id)->where('match_id' , $matchId)->get();
